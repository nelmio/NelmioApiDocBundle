                                    ...
                                    ->children()
                                        ->scalarNode('type')
                                            ->validate()
                                                ...
                                                ->thenInvalid('Invalid security type %s. Available types are: '.implode(', ', $securityTypes))
                                            ->end()
                                        ->end()
                                        ->scalarNode('scheme')
                                            ->validate()
                                                ->ifNotInArray($schemes = ['basic', 'bearer'])
                                                ->thenInvalid('Invalid security scheme %s. Available schemes are: '.implode(', ', $schemes))
                                            ->end()
                                        ->end()
                                        ->scalarNode('in')
                                            ->validate()
                                                ->ifNotInArray($in = ['header', 'query', 'cookie'])
                                                ->thenInvalid('Invalid security in %s. Available locations are: '.implode(', ', $in))
                                            ->end()
                                        ->end()
                                        ->scalarNode('name')->end()
