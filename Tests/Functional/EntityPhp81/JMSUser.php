...
class JMSUser
{
    ...
    #[OA\Property(description: 'User id', title: 'userid', example: 1, properties: ['readOnly' => true, 'default' => null])]
    private $id;
    ...
    #[Serializer\Expose]
    #[OA\Property(description: 'Roles list', example: '["ADMIN","SUPERUSER"]', title: 'roles', properties: ['default' => ['user']])]
    private $roles;
    ...
    #[Serializer\Type('array<Nelmio\ApiDocBundle\Tests\Functional\EntityPhp81\User>')]
    #[Serializer\Expose]
    private $friends;

    #[Serializer\Type('array<string, Nelmio\ApiDocBundle\Tests\Functional\EntityPhp81\User>')]
    #[Serializer\Expose]
    ...
    #[Serializer\Type(\Nelmio\ApiDocBundle\Tests\Functional\EntityPhp81\CustomDateTime::class)]
    #[Serializer\Expose]
    private $customDate;
    ...
    #[OA\Property(type: 'string', properties: ['minLength' => 1, 'maxLength' => 100])]
    ...
    #[Serializer\Type(\Nelmio\ApiDocBundle\Tests\Functional\EntityPhp81\JMSNote::class)]
    #[Serializer\Inline()]
    #[Serializer\Expose]
    private $notes;
