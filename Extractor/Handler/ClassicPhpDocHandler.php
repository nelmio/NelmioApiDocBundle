...
/**
 * Class ClassicPhpDocHandler
 *
 * Extracts classic phpDoc annotations
 *
 *  - @param
 *  - @deprecated
 *  - @link
 */
class ClassicPhpDocHandler implements HandlerInterface
{
    /**
    ...
    function __construct($commentExtractor)
    {
