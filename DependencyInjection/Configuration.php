        ...
        $treeBuilder
            ...
            ->children()
                ...
                ->arrayNode('parsers')
                    ->addDefaultsIfNotSet()
                    ->children()
                        ->booleanNode('CollectionParser')->defaultTrue()->end()
                        ->booleanNode('FormTypeParser')->defaultTrue()->end()
                        ->booleanNode('JmsMetadataParser')->defaultTrue()->end()
                        ->booleanNode('ValidationParser')->defaultTrue()->end()
                    ->end()
                ->end()
