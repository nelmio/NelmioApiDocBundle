...
class NelmioApiDocExtension extends Extension
{
    ...
    public function load(array $configs, ContainerBuilder $container)
    {
        ...
        $container->setParameter('nelmio_api_doc.sandbox.content_type', $config['sandbox']['content_type']);
        $container->setParameter('nelmio_api_doc.sandbox.instance_name', $config['sandbox']['instance_name']);
        $container->setParameter('nelmio_api_doc.sandbox.custom_headers', $config['sandbox']['custom_headers']);
