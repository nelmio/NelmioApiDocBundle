...
.. _`RouteArgumentDescriberInterface`: https://github.com/nelmio/NelmioApiDocBundle/blob/4.x/src/RouteDescriber/RouteArgumentDescriber/RouteArgumentDescriberInterface.php
